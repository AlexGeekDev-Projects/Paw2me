...
const LocationPickerAndroid: React.FC<LocationPickerProps> = ({
  value,
  onChange,
  height = 220,
}) => {
  ...
  const provider = useMemo<MapViewProps['provider']>(() => PROVIDER_GOOGLE, []);

  return (
    <View>
      {/* Wrapper RELATIVE: los controles se posicionan relativos a este contenedor */}
      <View style={[styles.mapWrapper, { height }]}>
        ...
        {/* Controles como HERMANO del mapa, superpuestos */}
        <MapControls
...
export default LocationPickerAndroid;
